...
def get_user_notifications_endpoint(user_id: str, db: Session = Depends(get_db)):
    """
...
def mark_user_notifications_read(request: MarkReadRequest, db: Session = Depends(get_db)):
    """
