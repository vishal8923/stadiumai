...
def report_new_incident(request: IncidentRequest, db: Annotated[Session, Depends(get_db)]):
...
def get_incident_details(incident_id: str, db: Annotated[Session, Depends(get_db)]):
